...
func GetTwtichLives() ([]map[string]interface{}, error) {
	token, clientId := getTwitchTokenAndClientID()
	users, err := getTwitchUsersFromJson()
	if err != nil {
		return nil, err
	}
...
func getTwitchTokenAndClientID() (string, string) {
	clientId, clientSecret := getTwitchKeyFromJson()
...
func getTwitchKeyFromJson() (string, string) {
...
func getTwitchUsersFromJson() ([]string, error) {
